...
const FEATURED_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a`
query {
  products(first: 50) {
    nodes {
      id
...
const Home = () => {
  ...
  const {
    ...
    loading,
    error
  } = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_3__["useQuery"])(_graphql_featured_query__WEBPACK_IMPORTED_MODULE_5__["default"]);
